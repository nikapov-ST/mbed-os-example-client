...
|------------------------------------------------------------------------------|----------------------------------------------------|-------------|---------------|
|[FRDM-K64F](https://developer.mbed.org/platforms/FRDM-K64F/)                  | `mbed_app.json`   | `configs/wifi_esp8266_v4.json` | multiple    | -             |
|[NUCLEO_F429ZI](https://developer.mbed.org/platforms/ST-Nucleo-F429ZI/)       | `mbed_app.json`   | `configs/wifi_esp8266_v4.json` | multiple    | -             |
|[UBLOX_EVK_ODIN_W2](https://developer.mbed.org/platforms/ublox-EVK-ODIN-W2/)  | `mbed_app.json`   | `configs/wifi_odin_v4.json`    |             | Ethernet requires EMAC override. |
|[REALTEK RTL8195AM](https://developer.mbed.org/platforms/REALTEK-RTL8195AM/)  | no ethernet       | `configs/wifi_rtw_v4.json`     |             | You *must* update [DAPLINK](https://developer.mbed.org/platforms/REALTEK-RTL8195AM/#daplink-firmware-update).) |
